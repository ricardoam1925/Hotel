...
@Component({
  selector: 'app-gen-especifico',
  templateUrl: './gen-especifico.page.html',
  styleUrls: ['./gen-especifico.page.scss'],
})
export class GenEspecificoPage implements OnInit {
  ...
  enviar_fecha(){
    if (this.fecha_inicial== null || this.fecha_final == null) {
      this.crear_alerta();   
  		...
  		this.router.navigate(['/general-especifico', this.date_inicial, this.date_final]);
